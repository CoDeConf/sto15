...
![Michael Sens]({{site.root}}/images/speakers/msens.jpg){: .portrait} On October the 22nd I will be speaking at the Continuous Delivery and DevOps Conference in Copenhagen where I will share experiences on a very successful implementation of a new website serving about 20.000.000 page views a month.
...
![A traditional software delivery process]({{site.root}}/images/speakers/slog.jpg)
...
![Overview of tooling for automating the software delivery process]({{site.root}}/images/speakers/slog2.jpg)
...
![An optimized software delivery process]({{site.root}}/images/speakers/slog3.jpg)
